...
Простой пример переписки с нейросетью с использованием библиотеки:
...
В итоге переменная будет содержать все сообщения этого диалога, который вы сможете отобразить. Для удобства в библиотеке уже есть форма для работы с диалогами и сообщениям, который вы можете использовать как есть или доработать под себя:
